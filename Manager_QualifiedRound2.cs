...
public class Manager_QualifiedRound2 : MonoBehaviour
{
    ...
    public GameObject jumpClubLoadingScreen;
    ...
    public IEnumerator selectMap()
    {
        ...
        // Show Jump Club loading screen
        jumpClubLoadingScreen.SetActive(true);
        // Wait for 10 seconds while loading audio plays
        yield return new WaitForSeconds(10);
        // Switch scene to Jump Club
        SceneManager.LoadScene("Jump_Club");
    }
}
